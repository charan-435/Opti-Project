...
if __name__ == "__main__":
    ...
    features = np.load(os.path.join(path, "data/outputs/features/features.npy"))
    labels = np.load(os.path.join(path, "data/outputs/features/labels.npy"))
    ...
    torch.save(m.state_dict(), os.path.join(path, "data/outputs/features/lstm_model.pth"))
    print("Done.")
